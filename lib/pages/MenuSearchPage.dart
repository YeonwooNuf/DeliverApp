...
class MenuSearchPage extends StatelessWidget {
  ...
  MenuSearchPage({required this.image_URL, required this.storeName});
          ...
          children: [
            ...
            Positioned(
                ...
                left: MediaQuery.of(context).size.width *
                    0.04, // 왼쪽 여백을 화면의 너비를 기준으로 설정합니다.
                right: MediaQuery.of(context).size.width *
                    0.04, // 오른쪽 여백을 화면의 너비를 기준으로 설정합니다.
                child: Container(
                  height:
                      MediaQuery.of(context).size.height * 0.15, // 화면의 절반 높이
